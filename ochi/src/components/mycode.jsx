...
// const Navbar = () => {
//   return (
//     <div className="fixed z-[999] w-full px-20 py-8 font-['Neue_Montreal']  flex justify-between items-center text-black">
//       <div className="logo">
//         <svg
//           width="72"
//           height="30"
...
{/* <div className=" flex items-center justify-center  text-white">
  <div className="bg-zinc-800 hover:bg-black flex items-center justify-center rounded-3xl w-60 h-12 gap-4 font-['Neue_Montreal']">
    {" "}
    <h1>VIEW ALL PROJECTS</h1>
    <div className="w-2 h-2 rounded-full bg-white hover:w-5 hover:h-5"></div>
  </div>
</div>; */}