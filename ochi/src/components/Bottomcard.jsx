...
import logo from "../assets/Zeth.svg"

const Bottomcard = () => {
  return (
    <div className="w-full h-screen  flex  items-center px-32 gap-5 bg-white">
      <div className="cardcontainer h-[30vw] w-1/2 ">
        <div className="card w-full rounded-3xl h-full  relative flex items-center justify-center bg-[#004D43]">
          <svg
            width="80"
            height="40"
            viewBox="0 0 72 30"
          ...
          <button className="absolute  px-5 py-2 border-2 left-10 bottom-4 rounded-4xl border-[#b7e314] text-[#b7e314] font-semibold">
            &copy;2025
          </button>
        </div>
      </div>
      <div className="cardcontainer2 flex gap-5 h-[30vw] w-1/2 ">
        <div className="card w-1/2 h-full rounded-3xl relative flex items-center justify-center bg-[#212121]">
          <img
            src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg"
            alt=""
          />
          <button className="absolute leading-none px-5 py-2 border-2  bottom-4 rounded-4xl border-[#fff] text-white font-md">
            RATING 5.0 ON CLUTCH
          </button>
        </div>
        <div className="card w-1/2 h-full realative rounded-3xl bg-[#212121] relative flex items-center justify-center">
          <img
            src="https://ochi.design/wp-content/uploads/2022/04/logo003.png"
            alt=""
          />
          <button className="absolute leading-none font-md px-5 py-2 border-2  bottom-4 rounded-4xl border-[#fff] text-white ">
