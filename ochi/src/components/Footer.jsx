...
const Footer = () => {
  return (
    <div
     ...
     className="bg-white w-full h-screen flex mt-10 mb-10 p-10">
      {/* div1 */}
      <div className=" h-screen text-black flex flex-col justify-between w-1/2">
        <div className=" div1  uppercase p-10">
          <h1 className="text-7xl font-[Neue_Montreal] font-bold tracking-tight">
            Eye-
          </h1>
          <h1 className="text-7xl font-[Neue_Montreal] font-bold tracking-tight">
            Opening
      ...
      {/* div2 */}
      <div className="text-black h-screen w-1/2 ">
        <div className="uppercase p-10 ">
          <h1 className="text-7xl  font-bold font-[Neue_Montreal] tracking-tight ">
            Presentations
          </h1>
        </div>
        <div className="leftDiv flex gap-10 flex-col">
          ...
          <div className="AddresDiv flex flex-col">
            <h1>L:</h1>
            <div className='flex flex-col underline'>
